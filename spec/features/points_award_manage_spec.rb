...
RSpec.describe 'PointsAwardManage', type: :feature do
  ...
  let!(:points) { create_list(:point, 1, numPointsAwarded:5, awardDescription:"words" , awardedTo: other_user.uid, user: other_user) }
  ...
  scenario 'Admin user deletes a point' do
    ...
    first('.delete-point-link').click

    expect(page).to have_content('Are you sure you want to permanently delete this point')
  end
end
